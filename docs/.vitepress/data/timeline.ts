...
export interface TimelineEvent {
  ...
  /** 月份 1–12，可选 */
  month?: number
  /** 日 1–31，可选；仅填写有可靠公开出处的确切日期，不确定则留空 */
  day?: number
  event: string
...
export const timeline: TimelineEra[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { year: '1997', month: 5, day: 11, event: 'IBM Deep Blue 击败国际象棋世界冠军卡斯帕罗夫（Kasparov），全球震动，登上各大报纸头版', event_en: 'IBM\'s Deep Blue defeats world chess champion Kasparov, shocking the world and dominating front pages.', link: '/treatises/ai-games', type: 'event', importance: 'major' },
      ...
      { year: '1998', month: 9, day: 4, event: '佩奇（Page）与布林（Brin）创立 Google，PageRank 把图算法推上互联网舞台', event_en: 'Page and Brin found Google, with PageRank bringing graph algorithms onto the center stage of the internet.', link: '/treatises/ai-in-usa', type: 'company', importance: 'major' },
      ...
      { year: '2004', month: 3, day: 13, event: 'DARPA Grand Challenge 首届无人车挑战在莫哈韦沙漠举行，全部参赛车辆中途故障', event_en: 'The first DARPA Grand Challenge for autonomous vehicles is held in the Mojave Desert; every entrant fails to finish.', link: '/treatises/autonomous-driving', type: 'event', importance: 'minor' },
      { year: '2005', month: 10, day: 8, event: 'Stanford 团队的 Stanley 在 DARPA Grand Challenge 完赛夺冠，自动驾驶进入工程化阶段', event_en: 'Stanford\'s Stanley wins the DARPA Grand Challenge, ushering autonomous driving into an engineering era.', link: '/treatises/autonomous-driving', type: 'event', importance: 'major' },
  ...
  },
  {
    ...
    events: [
      ...
      { year: '2011', month: 2, day: 16, event: 'IBM Watson 在 Jeopardy! 中击败人类冠军，认知计算概念进入大众视野', event_en: 'IBM Watson beats the human champions on *Jeopardy!*, bringing the idea of cognitive computing into public view.', link: '/houses/ibm-research', type: 'event', importance: 'major' },
      { year: '2011', month: 10, day: 4, event: '苹果发布 Siri，AI 走进数亿人的口袋', event_en: 'Apple launches Siri, putting AI into the pockets of hundreds of millions of users.', link: '/houses/apple-intelligence', type: 'product', importance: 'major' },
  ...
  },
  {
    ...
    events: [
      { year: '2012', month: 9, day: 30, event: 'AlexNet 赢得 ImageNet 竞赛，错误率骤降 10 个百分点，深度学习革命爆发', event_en: 'AlexNet wins the ImageNet competition by slashing error rates by 10 percentage points, igniting the deep-learning revolution.', link: '/annals/08-cnn-era', type: 'milestone', importance: 'milestone' },
      { year: '2013', month: 1, day: 16, event: 'Mikolov 等在 Google 发表 Word2Vec 论文，词向量成为 NLP 标准工具', event_en: 'Mikolov and colleagues at Google publish Word2Vec, making word embeddings a standard NLP tool.', link: '/treatises/nlp', type: 'paper', importance: 'major' },
      { year: '2013', month: 12, day: 19, event: 'DeepMind 发表《Playing Atari with Deep Reinforcement Learning》，Deep Q-Network 让 AI 学会打游戏', event_en: 'DeepMind publishes *Playing Atari with Deep Reinforcement Learning*, with Deep Q-Networks teaching AI to play video games.', link: '/houses/deepmind', type: 'paper', importance: 'major' },
      { year: '2014', month: 1, day: 26, event: 'Google 以约 6 亿美元收购 DeepMind，全球科技巨头 AI 收购竞赛拉开帷幕', event_en: 'Google acquires DeepMind for around $600 million, kicking off a global AI acquisition race among tech giants.', link: '/houses/deepmind', type: 'event', importance: 'major' },
      { year: '2014', month: 9, event: '苏茨克维（Sutskever）等发表 Seq2Seq 论文，用编解码器结构统一翻译与生成任务', event_en: 'Sutskever and colleagues publish the Seq2Seq paper, unifying translation and generation tasks under an encoder-decoder architecture.', link: '/biographies/ilya-sutskever', type: 'paper', importance: 'major' },
      { year: '2014', month: 9, event: 'Bahdanau 等首次把注意力机制（Attention）引入神经机器翻译', event_en: 'Bahdanau and colleagues introduce the attention mechanism into neural machine translation for the first time.', link: '/treatises/nlp', type: 'paper', importance: 'major' },
      { year: '2014', month: 6, day: 10, event: '古德费洛（Goodfellow）在蒙特利尔的酒吧灵感中发明生成对抗网络（GAN），开创生成式 AI', event_en: 'Goodfellow, in a flash of inspiration at a Montreal bar, invents Generative Adversarial Networks (GANs), opening the era of generative AI.', link: '/houses/mila', type: 'paper', importance: 'major' },
      ...
      { year: '2015', month: 11, day: 9, event: 'Google 开源 TensorFlow，深度学习工具民主化', event_en: 'Google open-sources TensorFlow, democratizing deep learning tooling.', link: '/treatises/ai-open-source', type: 'product', importance: 'major' },
      { year: '2015', month: 12, day: 10, event: '何恺明等发表 ResNet，残差连接突破百层深度，刷新 ImageNet 与 COCO 纪录', event_en: 'Kaiming He (何恺明) and colleagues publish ResNet; residual connections push networks past 100 layers and set new records on ImageNet and COCO.', link: '/annals/08-cnn-era', type: 'paper', importance: 'major' },
      { year: '2015', month: 12, day: 11, event: 'OpenAI 在旧金山宣告成立，马斯克与奥特曼承诺 10 亿美元，对抗"AI 被巨头垄断"', event_en: 'OpenAI is announced in San Francisco; Musk and Altman pledge $1 billion to counter "AI being monopolized by tech giants."', link: '/houses/openai', type: 'company', importance: 'major' },
      { year: '2016', month: 3, day: 15, event: 'AlphaGo 以 4:1 击败围棋世界冠军李世石（Lee Sedol），AI 攻克人类最复杂的棋类游戏', event_en: 'AlphaGo defeats world Go champion Lee Sedol 4–1, conquering humanity\'s most complex board game.', link: '/houses/deepmind', type: 'event', importance: 'milestone' },
      ...
      { year: '2017', month: 12, day: 5, event: 'DeepMind 发布 AlphaZero，仅凭自我对弈在围棋、国际象棋、将棋上全面超越人类', event_en: 'DeepMind releases AlphaZero, surpassing humans at Go, chess, and shogi through self-play alone.', link: '/houses/deepmind', type: 'paper', importance: 'major' },
      { year: '2017', month: 7, day: 8, event: '中国国务院印发《新一代人工智能发展规划》，明确 2030 年成为 AI 创新中心目标', event_en: 'China\'s State Council issues the *New Generation AI Development Plan*, setting the goal of becoming the world\'s AI innovation hub by 2030.', link: '/treatises/ai-in-china', type: 'policy', importance: 'major' },
    ],
  },
  {
    name: 'Transformer 纪元',
    ...
    events: [
      { year: '2017', month: 6, day: 12, event: '八位 Google 研究员发表《Attention Is All You Need》，Transformer 架构诞生，改变一切', event_en: 'Eight Google researchers publish *Attention Is All You Need*; the Transformer architecture is born and changes everything.', link: '/houses/google-brain', type: 'paper', importance: 'milestone' },
      { year: '2018', month: 6, day: 11, event: 'OpenAI 发布 GPT-1，提出"生成式预训练 + 微调"路线', event_en: 'OpenAI releases GPT-1, proposing the "generative pre-training plus fine-tuning" recipe.', link: '/treatises/llm', type: 'product', importance: 'major' },
      { year: '2018', month: 10, day: 11, event: 'Google 发布 BERT，双向预训练横扫 11 项 NLP 基准', event_en: 'Google releases BERT; bidirectional pre-training sweeps 11 NLP benchmarks.', link: '/treatises/llm', type: 'product', importance: 'major' },
      ...
      { year: '2019', month: 2, day: 14, event: 'OpenAI 发布 GPT-2（15 亿参数），以"太危险"为由延迟公开，引发开源与安全之争', event_en: 'OpenAI announces GPT-2 (1.5B parameters) but delays the full release as "too dangerous," sparking the open-source vs. safety debate.', link: '/treatises/llm', type: 'product', importance: 'major' },
      ...
      { year: '2019', month: 7, day: 22, event: '微软向 OpenAI 投资 10 亿美元，并签署 Azure 独家算力协议', event_en: 'Microsoft invests $1 billion in OpenAI and signs an exclusive Azure compute partnership.', link: '/houses/openai', type: 'event', importance: 'major' },
      { year: '2020', month: 5, day: 28, event: 'OpenAI 发布 GPT-3（1750 亿参数），少样本学习展示出"近似涌现"的能力', event_en: 'OpenAI releases GPT-3 (175B parameters); few-shot learning shows what looks like emergent capability.', link: '/treatises/llm', type: 'product', importance: 'major' },
      { year: '2020', month: 11, day: 30, event: 'DeepMind 在 CASP14 用 AlphaFold 2 解决蛋白质折叠问题，被誉为"50 年来最大突破"', event_en: 'DeepMind\'s AlphaFold 2 solves the protein-folding problem at CASP14, hailed as "the biggest breakthrough in 50 years."', link: '/treatises/ai-biology', type: 'event', importance: 'major' },
      ...
      { year: '2021', month: 1, day: 5, event: 'OpenAI 发布 DALL·E，文本到图像生成首次进入大众视野', event_en: 'OpenAI launches DALL·E, putting text-to-image generation in the public eye for the first time.', link: '/treatises/ai-art', type: 'product', importance: 'major' },
      { year: '2021', month: 6, day: 29, event: 'GitHub 推出 Copilot 预览，AI 开始正式协助程序员写代码', event_en: 'GitHub launches the Copilot preview, formally putting AI to work as a coding assistant for developers.', link: '/treatises/ai-agent', type: 'product', importance: 'major' },
      ...
      { year: '2022', month: 2, day: 2, event: 'DeepMind 发布 AlphaCode，能在编程竞赛中达到中等水平选手成绩', event_en: 'DeepMind releases AlphaCode, performing at the level of an average competitive programmer.', link: '/treatises/ai-agent', type: 'product', importance: 'minor' },
      { year: '2022', month: 7, day: 12, event: 'Midjourney 公开测试，扩散模型把 AI 绘画推向社交平台', event_en: 'Midjourney enters public beta; diffusion models push AI art onto social platforms.', link: '/treatises/ai-art', type: 'product', importance: 'major' },
      { year: '2022', month: 8, day: 22, event: 'Stability AI 开源 Stable Diffusion，扩散模型生态全面爆发', event_en: 'Stability AI open-sources Stable Diffusion, blowing open the entire diffusion-model ecosystem.', link: '/treatises/ai-art', type: 'product', importance: 'major' },
      ...
      { year: '2022', month: 11, day: 30, event: 'ChatGPT 发布，两个月用户破亿，成为史上增长最快的消费级应用', event_en: 'ChatGPT launches on November 30; reaching 100 million users in two months, it becomes the fastest-growing consumer app in history.', link: '/houses/openai', type: 'milestone', importance: 'milestone' },
    ],
  },
  {
    name: '生成式 AI 浪潮',
    ...
    events: [
      { year: '2023', month: 2, day: 7, event: '微软发布 Bing Chat（基于 GPT-4），与 Google 展开搜索保卫战', event_en: 'Microsoft launches Bing Chat (powered by GPT-4), opening a search war with Google.', link: '/houses/microsoft-research', type: 'product', importance: 'major' },
      { year: '2023', month: 2, day: 24, event: 'Meta 发布 LLaMA，权重通过申请方式开放，引爆开源大模型运动', event_en: 'Meta releases LLaMA with weights available on request, igniting the open-source LLM movement.', link: '/houses/meta-ai', type: 'product', importance: 'major' },
      { year: '2023', month: 3, day: 14, event: 'OpenAI 发布 GPT-4，多模态能力震撼业界', event_en: 'OpenAI releases GPT-4, whose multimodal capabilities stun the industry.', link: '/houses/openai', type: 'product', importance: 'major' },
      { year: '2023', month: 3, day: 14, event: 'Anthropic 发布 Claude 1，主打长上下文与安全可控', event_en: 'Anthropic releases Claude 1, emphasizing long context and safe, steerable behavior.', link: '/houses/anthropic', type: 'product', importance: 'major' },
      { year: '2023', month: 3, day: 9, event: '马斯克在 X.AI Corp 名下注册公司，xAI 雏形浮现', event_en: 'Musk registers a company under the name X.AI Corp, the embryonic form of xAI.', link: '/houses/xai', type: 'company', importance: 'minor' },
      { year: '2023', month: 5, day: 1, event: '辛顿（Hinton）从 Google 离职，公开警告通用 AI 的风险', event_en: 'Hinton resigns from Google and publicly warns of the risks of general AI.', link: '/biographies/hinton', type: 'person', importance: 'major' },
      ...
      { year: '2023', month: 7, day: 18, event: 'Meta 发布 LLaMA 2，免费商用许可让开源大模型真正走入企业', event_en: 'Meta releases LLaMA 2 under a free commercial license, finally bringing open-source LLMs into the enterprise.', link: '/houses/meta-ai', type: 'product', importance: 'major' },
      { year: '2023', month: 7, day: 12, event: 'xAI 正式成立，马斯克启动与 OpenAI、Anthropic 的三方竞争', event_en: 'xAI is officially founded, with Musk launching a three-way race against OpenAI and Anthropic.', link: '/houses/xai', type: 'company', importance: 'major' },
      { year: '2023', month: 7, day: 11, event: 'Anthropic 发布 Claude 2，100K 上下文成为核心卖点', event_en: 'Anthropic releases Claude 2, with a 100K-token context window as its headline feature.', link: '/houses/anthropic', type: 'product', importance: 'minor' },
      { year: '2023', month: 10, day: 30, event: '美国总统拜登签署 EO 14110 行政令，把前沿模型纳入国家安全监管', event_en: 'U.S. President Biden signs Executive Order 14110, bringing frontier models under national-security oversight.', link: '/treatises/ai-governance', type: 'policy', importance: 'major' },
      { year: '2023', month: 11, day: 17, event: 'OpenAI 董事会突然解雇奥特曼（Altman），五天后在员工与投资人压力下回归', event_en: 'OpenAI\'s board abruptly fires Altman; he returns five days later under pressure from staff and investors.', link: '/houses/openai', type: 'event', importance: 'major' },
      ...
      { year: '2024', month: 2, day: 15, event: 'OpenAI 发布 Sora 视频生成模型，把扩散模型与 Transformer 推向时间维度', event_en: 'OpenAI releases the Sora video model, extending diffusion models and Transformers into the time dimension.', link: '/treatises/ai-art', type: 'product', importance: 'major' },
      { year: '2024', month: 3, day: 4, event: 'Anthropic 发布 Claude 3 系列，Opus 在多项基准上超越 GPT-4', event_en: 'Anthropic releases the Claude 3 family; Opus surpasses GPT-4 on several benchmarks.', link: '/houses/anthropic', type: 'product', importance: 'major' },
      { year: '2024', month: 5, day: 13, event: 'OpenAI 发布 GPT-4o，原生多模态、低延迟语音交互', event_en: 'OpenAI releases GPT-4o with native multimodality and low-latency voice interaction.', link: '/houses/openai', type: 'product', importance: 'major' },
      { year: '2024', month: 5, day: 21, event: '欧盟正式通过《人工智能法案》（EU AI Act），全球首部综合性 AI 法律落地', event_en: 'The European Union formally adopts the AI Act, the world\'s first comprehensive AI law.', link: '/treatises/ai-governance', type: 'policy', importance: 'major' },
      { year: '2024', month: 9, day: 12, event: 'OpenAI 发布 o1 系列推理模型，"Test-time Compute"路线浮出水面', event_en: 'OpenAI releases the o1 family of reasoning models, surfacing the "test-time compute" research direction.', link: '/treatises/llm', type: 'product', importance: 'major' },
      ...
      { year: '2025', month: 1, day: 20, event: 'DeepSeek 发布 R1 推理模型，以极低成本接近 o1 水平，引爆全球开源讨论', event_en: 'DeepSeek releases the R1 reasoning model, approaching o1-level performance at a fraction of the cost and igniting a global open-source debate.', link: '/houses/deepseek', type: 'product', importance: 'milestone' },
      { year: '2025', month: 1, day: 23, event: '特朗普签署行政令撤销拜登的 EO 14110，美国 AI 治理路线转向加速主义', event_en: 'Trump signs an executive order revoking Biden\'s EO 14110, pivoting U.S. AI governance toward an accelerationist stance.', link: '/treatises/ai-governance', type: 'policy', importance: 'major' },
      { year: '2025', month: 1, day: 21, event: '美、日、阿联酋等宣布 Stargate 计划，规划 5000 亿美元级 AI 算力基础设施', event_en: 'The U.S., Japan, the UAE and partners announce the Stargate project, planning AI compute infrastructure on the $500 billion scale.', link: '/treatises/ai-hardware', type: 'policy', importance: 'major' },
      ...
      { year: '2025', month: 3, day: 28, event: 'xAI 收购 X（前 Twitter），构建"模型+社交+数据"一体化平台', event_en: 'xAI acquires X (formerly Twitter), building an integrated "model + social + data" platform.', link: '/houses/xai', type: 'event', importance: 'major' },
      { year: '2025', month: 8, day: 7, event: 'OpenAI 发布 GPT-5，推理、工具调用与多模态能力进一步统一', event_en: 'OpenAI releases GPT-5, further unifying reasoning, tool use, and multimodal capabilities.', link: '/houses/openai', type: 'product', importance: 'major' },
      { year: '2025', month: 5, day: 22, event: 'Anthropic 发布 Claude 4 系列，Agent 与编码场景成为旗舰能力', event_en: 'Anthropic releases the Claude 4 family, with agentic and coding workflows becoming its flagship capabilities.', link: '/houses/anthropic', type: 'product', importance: 'major' },
